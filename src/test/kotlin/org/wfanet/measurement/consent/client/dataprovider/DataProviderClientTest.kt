...
class DataProviderClientTest {
  ...
  fun `data provider indicate requisition participation`() {
    ...
    assertThat(dataProviderParticipation.data.toByteArray().joinToString())
      .isEqualTo(
        "5, 0, 64, 63, 17, 14, 102, -93, -34, -104, 89, 117, -96, -106, 23, 101, 2, -95, 43," +
          " 106, 14, -100, 32, 21, -9, 123, -101, -4, 38, -87, 85, -101, 82, 79, 20, 13, -75," +
          " -80, 42, -5, -72, -109, -115, -52, 64, 70, -84, 57, -102, 7, 68, 94, -33, -83, 28," +
          " -118, -125, 22, -110, -50, 98, 90, -93, -60, 115, 111, 109, 101, 45, 115, 101, 114," +
          " 105, 97, 108, 105, 122, 101, 100, 45, 109, 101, 97, 115, 117, 114, 101, 109, 101," +
          " 110, 116, 45, 115, 112, 101, 99"
      )
