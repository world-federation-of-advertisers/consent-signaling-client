...
/**
 * [FakeSigner] is an implementation of [Signer] that returns the [signature] as the first 10
 * characters of the reverse of the original data. This should only be used for bring-up, unit
 * testing, or debugging. Do not use in production.
 */
