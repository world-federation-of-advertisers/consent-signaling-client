 ...
 * @throws SignatureException if the signature is invalid
 * @throws VerificationException if the Measurement public key or nonce hashes mismatch
 */
@Throws(CertPathValidatorException::class, SignatureException::class, VerificationException::class)
fun verifyRequisitionSpec(
  ...
  if (requisitionSpec.measurementPublicKey != measurementSpec.measurementPublicKey) {
    throw VerificationException("Measurement public key mismatch")
  }
  if (!measurementSpec.nonceHashesList.contains(hashSha256(requisitionSpec.nonce))) {
    throw VerificationException("Nonce hash mismatch")
  }
}
