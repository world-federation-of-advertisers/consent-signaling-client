...
fun decryptRequisitionSpec(
  ...
  dataProviderPrivateKeyHandle: org.wfanet.measurement.common.crypto.PrivateKeyHandle
): SignedData {
  return SignedData.parseFrom(
    dataProviderPrivateKeyHandle.hybridDecrypt(encryptedSignedDataRequisitionSpec)
  )
}
