 ...
 */
val FIXED_CERT_PEM_FILE = getRuntimePath(TESTDATA_DIR_PATH.resolve("server.pem"))!!.toFile()
val FIXED_KEY_FILE = getRuntimePath(TESTDATA_DIR_PATH.resolve("server.key"))!!.toFile()
